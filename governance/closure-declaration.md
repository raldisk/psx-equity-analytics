...
|---|---|---|
| Governance validation complete | ✅ | 9 adversarial findings addressed; hardening-log.md complete |
...
│       └── psx_pipeline_dag.py
├── tests/
│   └── test_psx_analytics_regression.py   # 17 tests; F-019/F-022/F-023/F-025 regression coverage
├── governance/
│   ├── hardening-log.md
│   └── closure-declaration.md (this file)
├── .env.example
├── .gitignore
├── requirements.txt
└── README.md
...
```
pytest tests/test_psx_analytics_regression.py -k "not sarima and not SARIMA"
